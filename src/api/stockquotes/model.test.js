...
beforeEach(async () => {
  stockquotes = await Stockquotes.create({ isin: 'test', wkn: 'test', symbol: 'test', date: 'test', currency: 'test', high: 'test', low: 'test', price: 'test', marketcap: 'test', kgv: 'test', dividentprecent: 'test', vola: 'test', high52: 'test', low52: 'test', country: 'test', exchange: 'test' })
})
